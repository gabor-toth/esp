...
// OWN start
// see esp-idf/examples/common_components/protocol_examples_common/wifi_connect.c
// winmergeu C:\Espressif\frameworks\esp-idf-v5.2.1\examples\common_components\protocol_examples_common\wifi_connect.c C:\Users\gtoth00\projects\own\esp\common\wifi\wifi_connect.c
// OWN end
...
void example_wifi_start(void)
{
    ...
    // OWN added
    wifi_set_hostname(s_example_sta_netif);
    // OWN added ESP_ERROR_CHECK
...
esp_err_t example_wifi_sta_do_disconnect(void)
{
    // ESP_ERROR_CHECK fails on ESP_ERR_NOT_FOUND
...
esp_err_t example_wifi_connect(void)
{
    ...
    // OWN added
    wifi_scan_get_ssid_and_password( &wifi_config.sta );
#if CONFIG_EXAMPLE_WIFI_SSID_PWD_FROM_STDIN
...
#endif
    // OWN modified "true" -> " !ASYNC_WIFI_INIT"
